						...
						<table>	
							<tbody>						
					  			<tr>
					  				...
					  				<td style="padding-left: 15px"><span id="ioRawTempFlowRadiator" yaha="io_mode:read_cyclic ; format:0.##">tbd...</span> V</td>
					  				<td style="padding-left: 15px"><span id="actTempFlowRadiator" yaha="io_mode:read_cyclic ; format:00.# ; unit:$deg$C>$deg$C show">tbd...</span></td>
					  			</tr>
					  			<tr>
					  				<td>$yaha_tuid:flowfloor$</td>
					  				<td style="padding-left: 15px"><span id="ioRawTempFlowFloor" yaha="io_mode:read_cyclic ; format:0.##">tbd...</span> V</td>
					  				<td style="padding-left: 15px"><span id="actTempFlowFloor" yaha="io_mode:read_cyclic ; format:00.# ; unit:$deg$C>$deg$C show">tbd...</span></td>
					  			</tr>
					  			<tr>
					  				<td>$yaha_tuid:northside$</td>
					  				<td style="padding-left: 15px"><span id="ioRawTempOutsideNorth" yaha="io_mode:read_cyclic ; format:0.##">tbd...</span> V</td>
					  				<td style="padding-left: 15px"><span id="actTempOutsideNorth" yaha="io_mode:read_cyclic ; format:00.# ; unit:$deg$C>$deg$C show">tbd...</span></td>
					  			</tr>
					  			<tr>
					  				<td>$yaha_tuid:boiler$</td>
					  				<td style="padding-left: 15px"><span id="ioRawTempBoiler" yaha="io_mode:read_cyclic ; format:0.##">tbd...</span> V</td>
					  				<td style="padding-left: 15px"><span id="actTempBoiler" yaha="io_mode:read_cyclic ; format:00.# ; unit:$deg$C>$deg$C show">tbd...</span></td>
					  			</tr>
					  			<tr>
					  				<td>$yaha_tuid:lounge$</td>
					  				<td colspan=2 style="padding-left: 15px"><span id="actTempRoomLounge" yaha="io_mode:read_cyclic ; format:00.# ; unit:$deg$C>$deg$C show">tbd...</span></td>
					  			</tr>
					  			<tr>
					  			...
					  			<tr>
					  				<td colspan=3>
										...
										yaha="io_mode:read_cyclic, write_change">							
					  				</td>
					  			</tr>
					  		</tbody>							
						</table>
						...
						<table>	
							<tbody>						
					  			<tr>
					  				...
					  				<td style="padding-left: 15px"><span id="ioRawTempBurner" yaha="io_mode:read_cyclic ; format:0.##">tbd...</span> V</td>
					  				<td style="padding-left: 15px"><span id="actTempBurner" yaha="io_mode:read_cyclic ; format:00.# ; unit:$deg$C>$deg$C show">tbd...</span></td>
					  			</tr>
