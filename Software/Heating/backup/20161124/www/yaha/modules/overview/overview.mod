	...
	<![CDATA[
		<script type="text/javascript">
			...
			function trendLineChartInit()
			{
				...
				//start automatic refresh when recording
				$(document).on("click", "#trendStart",
					function(event)
					{
						TrendRefreshTimer = setInterval(function(){ drawTrend() }, 1000)
					});		

				//stop refresh to avoid blinking of chart
				$(document).on("click", "#trendStop",
					function(event)
					{
			...
			function drawTrend()
			{
				fileName = LOG_PATH + LOG_FILE_NAME_TRUNK + LOG_FILE_NAME_SUFFIX

				drawLineChart("trend_chart", fileName, "mixPosActFloor", "%Y.%m.%d %H:%M:%S", "%H:%M:%S", "", 15, ChartLegendTranslation)		
			}
		...
		<div style="visibility:hidden">
			...
			<span id="actTempBoiler" style="visibility:hidden" yaha="io_mode:read_cyclic ; anim_target_id:heatingCircuitSVG ; anim_svg_item_id:hc_boiler_temp_act ; anim_attribute:textContent ; anim_format:0.0 ; anim_unit:$deg$C>$deg$C show"></span>
			...
			<span id="floorHeatingMixerState" style="visibility:hidden" yaha="io_mode:read_cyclic ; anim_target_id:heatingCircuitSVG ; anim_svg_item_id:hc_floor_mixer_state ; anim_attribute:style,fill ; anim_attr_val_map:0=#ffffff,1=#0000ff,2=#ff0000"></span>
			<span id="radiatorHeatingMixerState" style="visibility:hidden" yaha="io_mode:read_cyclic ; anim_target_id:heatingCircuitSVG ; anim_svg_item_id:hc_radiator_mixer_state ; anim_attribute:style,fill ; anim_attr_val_map:0=#ffffff,1=#0000ff,2=#ff0000"></span>
					...
					<div class="ui-body ui-body-a ui-corner-all ui-dashboard-panel">
						...
						<table>	
							<tbody>						
					  			...
					  			<tr>
					  				<td><span id="alarmIOsimulationEffect" style="color:red;">$yaha_tuid:iosimulationactive$</span></td>
					  			</tr>
					  		</tbody>
					  	</table>				
					</div>
										    ...
										    <table>
										    	...
										    	<tbody id="pumphotwatermanualoperation">
										    		...
										    		<tr>
										  				<td>$yaha_tuid:totaloperatinghours$</td>
					  									<td style="text-align:left">
					  										<span id="hotwaterPumpTotalOperatingHours" yaha="io_mode:read_cyclic ; format:0.0 ; unit:min>h show">0.0</span>
										    			</td>
										    		</tr>
										    		<tr>
										  				<td>$yaha_tuid:annualoperatinghours$</td>
					  									<td style="text-align:left">
					  										<span id="hotwaterPumpAnnualOperatingHours" yaha="io_mode:read_cyclic ; format:0.0 ; unit:min>h show">0.0</span>
										    			</td>
										    		</tr>
										    	</tbody>
										    </table>										    
							...
							<tbody>	
					  			<tr>							
									...
									<td style="vertical-align:top; padding-left: 40px">
									  	<a href="#" id="trendStart" data-role="button" data-icon="video" data-mini="true" data-inline="true" style="display: inline-block; width: 80px" id="cmdRecorderStart" yaha="io_mode:write_click ; tag_group_wr_click:RECORDER_CMD_START">$yaha_tuid:start$</a>
									  	<br>
									  	<a href="#" id="trendStop" data-role="button" data-icon="forbidden" data-mini="true" data-inline="true" style="display: inline-block; width: 80px" id="cmdRecorderStop" yaha="io_mode:write_click ; tag_group_wr_click:RECORDER_CMD_STOP">$yaha_tuid:stop$</a>
									  	<br>
									  	<a href="#" id="trendClear" data-role="button" data-icon="delete" data-mini="true" data-inline="true" style="display: inline-block; width: 80px" id="cmdRecorderClear" yaha="io_mode:write_click ; tag_group_wr_click:RECORDER_CMD_CLEAR">$yaha_tuid:clear$</a>
									</td>
								</tr>
							</tbody>
						</table>
