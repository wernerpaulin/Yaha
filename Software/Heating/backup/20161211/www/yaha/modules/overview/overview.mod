...
<module>
	...
	<![CDATA[
		<script type="text/javascript">
			...
			if ($('input[name=heatingmode]:checked', '#form_operating_mode').val() == 'notAtHome')
			{
			...
			function statisticsLineChartInit()
			{
				...
				drawLineChart("statistics_linechart", fileName, "burnerDailyOperatingHours", "%Y.%m.%d %H:%M:%S", "%d %b %H:%M", "", 15, ChartLegendTranslation, 5)
								...
								<table>	
									<tbody>						
							  			...
							  			<tr id="notAtHome_details_leaving">
							  				...
							  				<td>
							  					<input id="globalHeatingNotAtHomeStartDate" type="date" value="" yaha="io_mode:read_cyclic, write_blur">$yaha_tuid:at$
							  					<input id="globalHeatingNotAtHomeStartTime" type="time" value="" yaha="io_mode:read_cyclic, write_blur">
							  				</td>
							  			</tr>					  			
							  			<tr id="notAtHome_details_backhome">
							  				<td>$yaha_tuid:backhome$</td>
							  				<td>
							  					<input id="globalHeatingNotAtHomeEndDate" type="date" value="" yaha="io_mode:read_cyclic, write_blur">$yaha_tuid:at$
							  					<input id="globalHeatingNotAtHomeEndTime" type="time" value="" yaha="io_mode:read_cyclic, write_blur">
							  				</td>
							  			</tr>
							  		</tbody>
							  	</table>						        
		...
		<div id="yaha_submodule_4" class="yaha-submodule" yaha="module_name: $yaha_tuid:manualoperation$ ;module_icon: yaha_hand; visible: onload">
			<div class="yaha_flex_header">
