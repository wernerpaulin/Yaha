            ...
            for tag in self.processTags:
                ...
                if tagAttributeList != None:
                    ...
                    if LOGIC_AND in tagAttributeList: 
                        ...
                        #print("tag: {0}, signalValue: {1}, pdiValue: {2}".format(tag, signalValue, pdiValue))
                    elif CMP_MAX in tagAttributeList:
                        if (pdiValue > signalValue):
                           signalValue = pdiValue
                    elif CMP_MIN in tagAttributeList:
                        if (pdiValue < signalValue):
                           signalValue = pdiValue
                    else:
                        signalValue = pdiValue  #for all analog values without attributes
