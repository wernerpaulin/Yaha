										    ...
										    <table>
										    	...
										    	<tbody id="roomcontrollerFloorHeatingManualoperation">
										    		...
										    		<tr>
					  									...
					  									<td style="text-align:left">
															<span id="floorHeatingManSetFlowTemp" yaha="io_mode:read_cyclic ; format:0.0"></span>&deg;C
										    			</td>
										    		</tr>
										    	</tbody>
										    </table>										    
										    ...
										    <table>
										    	...
										    	<tbody id="roomcontrollerRadiatorHeatingManualoperation">
										    		...
										    		<tr>
										  				<td>$yaha_tuid:setflowtemperature$</td>
					  									<td style="text-align:left">
															<span id="radiatorHeatingManSetFlowTemp" yaha="io_mode:read_cyclic ; format:0.0"></span>&deg;C
										    			</td>
										    		</tr>
										    	</tbody>
										    </table>										    
