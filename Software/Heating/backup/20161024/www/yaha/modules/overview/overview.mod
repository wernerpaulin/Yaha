...
<module>
	...
	<![CDATA[
		<script type="text/javascript">
			...
			function refreshHeatCurve(chartHandle, t_room_set_ID, t_slope_ID, level_ID)
			{
				...
				for (outTemp = outTempMin; outTemp <= outTempMax; outTemp += outTempStep)
				{
					...
					//put point on chart
					chartHandle.datasets[0].addPoint(outTemp, flowTemp);
				}
								...
								<table>	
									<tbody>						
							  			...
							  			<tr>
									        ...
									        <td><input type="radio" name="heatingmode" id="id_op_mode_suspend_ventilation" value="holiday">
		...
		<div id="yaha_submodule_2" class="yaha-submodule" yaha="module_name: $yaha_tuid:settings$ ;module_icon: yaha_settings; visible: onload">
			<div class="yaha_flex_header">
			...
			<div class="yaha_flex_container">
				<div class="yaha_flex_item">
					<div class="ui-body ui-body-a ui-corner-all ui-dashboard-panel" data-role="collapsible" data-inset="false" data-collapsed="false">
						<h3>$yaha_tuid:floorheating$</h3>
						...
						<table border=1>	
							<tbody>						
					  			<tr>
					  				<td>
					  					<div class="rotate90left"><span style="font-size:14px">$yaha_tuid:flowtemperature$</span></div>
					  				<td>
					  				<td colspan=2>
			...
			<div class="yaha_flex_container">
				<table border=1>
					<tbody>
						<tr>
							<td>
								<div id="heatingprocessgraphic" style="width: 600px; height: 400px">
									Grafik - alles mit DIV erledigen 
									<input type="number">
										<div style="position: absolute; top: 0px; left: 0px; width: 300px; height: 300px;">
										    <div style="position: relative; top: 120px; left: 20px; width: 250px;">positioned relative to the parent div</div>
										</div>									
								</div>
