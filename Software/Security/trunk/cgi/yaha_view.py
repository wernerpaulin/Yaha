...
legendTranslationList = {'empty': 0}    #force creating a dictionary
legendTranslationList.clear()           #clear dictionary immediately


YAHA_VIEW_MODULE_PATH = '/var/www/yaha/modules'
YAHA_LANGUAGE_DEFINITION_FILE = '/var/www/yaha/core/translation/languages.tmx'
YAHA_CHART_LEGEND_TRANSLATION_FILE = '/var/www/yaha/core/translation/chartlegend.tmx'
...
elif (requestType == "getLegendTranslation"):
    legendTranslationList.clear()

    try:
        #create translation map from ID to requested language
        #legendTranslationList["actTempOutdoor"] = "Aussentemperatur"
        #legendTranslationList["rainHourly"] = "Regenmenge pro Stunde"
        #legendTranslationList["uvRadiation"] = "UV Strahlung"

        legendTranslationList = createTranslationMap(YAHA_CHART_LEGEND_TRANSLATION_FILE, language)
    except:
        legendTranslationList.clear()
    #reply to client in json format
    #{"actTempOutdoor": "Aussentemperatur", "rainHourly": "Regenmenge pro Stunde"};
    print json.dumps(legendTranslationList)
