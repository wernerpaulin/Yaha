...
try:
    ...
    print("Enocean driver import error: {0} in line {1}".format(e, sys.exc_info()[-1].tb_lineno))
...
class main():
    ...
    def __init__(self, PDI):
        ...
        try:
            ...
            print("Enocean driver init error: {0} in line {1}".format(e, sys.exc_info()[-1].tb_lineno))
