...
<module>
	...
	<![CDATA[
		...
		<div style="visibility:hidden">
			...
			<span id="alarmCenterState" style="visibility:hidden" yaha="io_mode:read_cyclic ; effect_target_id:alarmCenterStateEffect ; effect_type:visibility ; effect_value_map:0=hide,1=show"></span>
			<span id="ioSupplyVoltageOk" style="visibility:hidden" yaha="io_mode:read_cyclic ; effect_target_id:ioSupplyVoltageOkEffect ; effect_type:visibility ; effect_value_map:1=hide,0=show"></span>
		</div>	
		...
		<div id="yaha_submodule_1" class="yaha-submodule" yaha="module_name: $yaha_tuid:dashboard$ ; module_icon: yaha_dashboard; visible: onload">
			<div class="yaha_flex_header" style="text-align:center">
				...
				<span id="alarmCenterStateEffect" class="blink" style="color:red; display:inline; font-size:20px; font-weight:bold">$yaha_tuid:armed$</span>
			</div>
			...
			<div class="yaha_flex_container">
				...
				<div class="yaha_flex_item">
					<div class="ui-body ui-body-a ui-corner-all ui-dashboard-panel">
						...
						<a href="#" id="cmdButtonAlarmLight" yaha="io_mode:write_click ; tag_group_wr_click:BUTTON_ALARM_LIGHT" data-role="button" data-icon="light" data-mini="true" data-inline="true">$yaha_tuid:flashlight$</a>
						<span style="visibility:hidden" id="uiButtonAlarmLight" yaha="tag_group:BUTTON_ALARM_LIGHT">1</span>
						
						<a href="#" id="cmdButtonAlarmSound" yaha="io_mode:write_click ; tag_group_wr_click:BUTTON_ALARM_SOUND" data-role="button" data-icon="sound" data-mini="true" data-inline="true">$yaha_tuid:sirene$</a>
					        ...
					        <fieldset data-role="controlgroup">
								<table>	
									<tbody>						
										...
										<tr>
											<td colspan=2>
												<span id="ioSupplyVoltageOkEffect" class="blink" style="color:red; display:inline; ">$yaha_tuid:powermainsdownbatterymode$</span>
											</td>
										</tr>
