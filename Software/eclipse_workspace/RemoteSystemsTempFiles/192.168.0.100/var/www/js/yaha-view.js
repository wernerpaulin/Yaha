 ...
 * Listenelemente mit jQuery Funktion in Array umwandeln: als yv call back function in update event einhängen
 * Liste bei Module init automatisch mot Modulreihenfolge laden
 * Als cookie abspeichern
 * Default Initialisierung von array löschen
 * */
...
function yvSwitchLanguage(languageID)
{
	...
	reloadYahaModules(ActiveLanguage, function()
			{
				yvWriteCookieLanguage(languageID)
