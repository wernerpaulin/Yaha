	...
	<body id="top">
		...
		<!-- One -->
			<section id="one" class="wrapper style1">
				...
				<div class="container">
					<section>
						<form method="post" action="mailer.php" onsubmit="MM_validateForm('from','','RisEmail','subject','','R','verif_box','','R','message','','R');return document.MM_returnValue">
							<div style="width:50%">
								<div class="6u 12u$(4)">
								...
								<br />
								<div class="6u$ 12u$(4)">
									<input type="email" name="from" id="from" value="" placeholder="Email address" />
								</div>
								<br />
								<div class="6u$ 12u$(4)">
								...
								<br />
								<div class="12u$">
									<input name="verif_box" type="text" id="verif_box" placeholder="Please enter the numbers you see below"/>
									<img style="padding-top: 10px" src="verificationimage.php?<?php echo rand(0,9999);?>" alt="verification image, type it in the box" height="50" align="absbottom" />
									<br />
								</div>
					...
					<section>
						<div class="fb-share-button" data-href="http://yaha-project.org/" data-layout="button" data-size="large" data-mobile-iframe="true"><a class="fb-xfbml-parse-ignore" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fyaha-project.org%2F&amp;src=sdkpreparse">Share</a></div>					
					</section>
				</div>
			</section>		
