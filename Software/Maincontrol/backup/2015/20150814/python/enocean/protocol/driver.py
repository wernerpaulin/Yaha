...
class main():
    ...
    def addDevice(self, deviceID='ffffffff'):
        #create device
    ...
    def addDeviceFunctionTypes(self, deviceID='ffffffff', funcTypeRPS=None, funcType1BS=None, funcType4BS=None, funcTypeVLD=None):
        deviceID = deviceID.lower()                 #ID is always considered lower case
