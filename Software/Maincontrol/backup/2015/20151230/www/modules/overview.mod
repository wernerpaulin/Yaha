				...
				<div class="yaha_flex_item">
					<div data-role="collapsible">
						...
						<p>Current recipe: <span id="uiCurrentRcpName" yaha="io_mode:read_cyclic">tbd...</span></p>
					  	...
					  	<select id="uiRcpNameSelector" yaha="io_mode:write_blur ; select_data:uiRcpNameList; select_value:uiCurrentRcpName">
						...
						<div style="visibility:hidden">
							<span id="uiCmdLoadRcp" yaha="tag_group:RCP_LOAD">1</span>
							<span id="uiCmdSaveRcp" yaha="tag_group:RCP_SAVE">1</span>
						</div>
