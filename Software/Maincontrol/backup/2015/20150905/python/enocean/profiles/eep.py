...
class PacketTypeRadio():
    ...
    def pack(self, subType):
        ...
        try:
            txData, txOptData = self.subTypePack(hostIDwithChannel, self.ownID)         #execute pack-function
