...
<module>
	...
	<html_data>
	<![CDATA[
		<div id="yaha_submodule_1" class="yaha-submodule" yaha="module_name: $yaha_tuid:nav0001$ ; module_icon: yaha_multimedia">
			<p>$yaha_tuid:cont0001$</p>
			<a href=debug.html>PDI Test page</a>
		</div>
		...
		<div id="yaha_submodule_3" class="yaha-submodule" yaha="module_name: $yaha_tuid:nav0003$ ;module_icon: yaha_multimedia; visible: onload">
