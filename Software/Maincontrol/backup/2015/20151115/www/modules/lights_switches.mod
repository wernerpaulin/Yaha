			...
			<table data-role="table" class="ui-responsive ui-shadow">
				...
				<tbody>
					  <tr>
					    <td>On / Off:</td>
					    <td>
					    	<a href="#" id="cmdLight1On" yaha="io_mode:write_click ; tag_group_wr_click:LIGHT1_ON">on</a>
					    	<a href="#" id="cmdLight1Off" yaha="io_mode:write_click ; tag_group_wr_click:LIGHT1_OFF">off</a>

					    </td>
					    <td>
					    	<a href="#" data-role="button" data-mini="true" id="cmdLight2On" yaha="io_mode:write_click ; tag_group_wr_click:LIGHT2_ON">on</a>
					    	<a href="#" data-role="button" data-mini="true" id="cmdLight2Off" yaha="io_mode:write_click ; tag_group_wr_click:LIGHT2_OFF">off</a>
					    </td>
					  </tr>
					  <tr>
					    <td>On time:</td>
					  ...
					  <tr>
					    <td>Learning:</td>
					    <td>
					    	<a href="#" data-role="button" data-mini="true" id="cmdLight1teach" yaha="io_mode:write_click ; tag_group_wr_click:LIGHT1_TEACH">learn</a>
					    </td>
					    <td>
					    	<a href="#" data-role="button" data-mini="true" id="cmdLight2teach" yaha="io_mode:write_click ; tag_group_wr_click:LIGHT2_TEACH">learn</a>
					    </td>
					  </tr>
				</tbody>
			</table>
