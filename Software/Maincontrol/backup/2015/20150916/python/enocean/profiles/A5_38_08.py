...
class A5_38_08():
    ...
    def unpack(self, data, optData):
        print("Enocean: A5_38_08 profile pack not defined")
    ...
    def buildOperationalData(self):
        ...
        #DB3.7-3.0
        dataBytes.append(self.CMD_SWITCHING)                #fixed coded CMD_SWITCHING: in case further variables will be added (dimming) a selector in PDI has to be implemented per data point (channel.CMD_xy)
