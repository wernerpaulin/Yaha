...
*/
	...
	function drawPieChart()
	{
		...
		d3.csv("yaha/core/reports/piechart_data.csv", function(error, data) {
	...
	d3.csv("yaha/core/reports/linechart_data.csv", function(error, data) {
		  if (error) throw error;
...
/* Animation - End */
  ...
  legend.append("text")
	...
	function drawStackedAreaChart()
	{
		...
		d3.csv("yaha/core/reports/barchart_data.csv", function(error, data) {
		  if (error) throw error;
