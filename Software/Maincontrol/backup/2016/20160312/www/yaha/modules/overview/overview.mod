...
<module>
	...
	<![CDATA[
		...
		<div id="yaha_submodule_1" class="yaha-submodule" yaha="module_name: $yaha_tuid:nav0001$ ; module_icon: yaha_dashboard">
			...
			<p>Count 1<input type="text" id="count1" yaha="io_mode:read_cyclic, write_enter" class="count_field"></p>
		...
		<div id="yaha_submodule_4" class="yaha-submodule" yaha="module_name: $yaha_tuid:nav0004$ ;module_icon: yaha_debug">
			...
			<div class="yaha_flex_container">
				<div class="yaha_flex_item">
				  	Cycle time: <span id="systemTickRunTime" yaha="io_mode:read_cyclic ; format:00.## ; unit:s>ms show">tbd...</span>
				  	<br>
					CPU load: <span id="cpuLoad" yaha="io_mode:read_cyclic ; format:00.# ; unit:N>% show">tbd...</span>
				</div>
				<div class="yaha_flex_item">
					<textarea name="txtLogOutput" id="logEnocean" rows="1" cols="1" style="width:640px;height:240px">
						deaktiviert wegen UDP-Frame size
				    </textarea>	
				</div>
				<div class="yaha_flex_item">
				  	<a href="#" data-role="button" data-mini="true" data-inline="true" id="cmdStopSystem" yaha="io_mode:write_click ; tag_group_wr_click:STOP_SYSTEM">Stop Yaha System</a>
						...
						<table data-role="table" class="ui-responsive ui-shadow">
							...
							<tbody>						
					  			<tr>
			    					...
			    					<td><span id="currentHour" yaha="io_mode:read_cyclic ; format:00"></span>:<span id="currentMinute" yaha="io_mode:read_cyclic ; format:00"></span>:<span id="currentSecond" yaha="io_mode:read_cyclic ; format:00"></span></td>
			    					<td><input type="time" id="setTimeString" yaha="tag_group:DATETIME_SET" value=""></td>
			  					</tr>			
					  			<tr>
			    					<td>$yaha_tuid:cont0008$</td>
			    					<td><span id="currentDay" yaha="io_mode:read_cyclic ; format:00"></span>.<span id="currentMonth" yaha="io_mode:read_cyclic ; format:00"></span>.<span id="currentYear" yaha="io_mode:read_cyclic ; format:00"></span></td>
			    					<td><input type="date" id="setDateString" yaha="tag_group:DATETIME_SET" value=""></td>
			  					</tr>	
			  					<tr>
			    					<td colspan=3>
									  	<a href="#" data-role="button" data-icon="check" data-mini="true" data-inline="true" id="uicmdSetDateTime" yaha="io_mode:write_click ; tag_group_wr_click:DATETIME_SET">$yaha_tuid:cont0011$</a>
