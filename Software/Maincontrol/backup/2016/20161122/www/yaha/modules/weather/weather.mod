...
<module>
	...
	<![CDATA[
			...
			function moduleInit()
			{
				...
				jQuery.post(CGI_SCRIPT_NAME_YAHA_VIEW, cgiData,
				    ...
				    {	
						...
						drawLineChart("weather_linechart", fileName, "actTempOutdoor", "%Y.%m.%d %H:%M:%S", "%d %b %H:%M", "", 15, ChartLegendTranslation, 5)

						drawWindHistoryChart("windhistorychart", fileName, "blue", ChartLegendTranslation)
				    });	
				...
				$(document).on("keypress", "#yearLog",
					function(event)
					{
						...
						if (keycode == '13')	//enter key
						{
							...
							drawLineChart("weather_linechart", fileName, "actTempOutdoor", "%Y.%m.%d %H:%M:%S", "%d %b %H:%M", "", 15, ChartLegendTranslation)
						}
						else
						{
				...
				$(document).on("blur", "#yearLog",
					function(event)
					{
						fileName = WEATHER_LOG_PATH + WEATHER_LOG_FILE_NAME_TRUNK + $("#yearLog").val() + WEATHER_LOG_FILE_NAME_SUFFIX
						drawLineChart("weather_linechart", fileName, "actTempOutdoor", "%Y.%m.%d %H:%M:%S", "%d %b %H:%M", "", 15), ChartLegendTranslation
						drawWindHistoryChart("windhistorychart", fileName, "blue") 
					});			
			}
						...
						<table>
							<tbody>
								<tr>
									...
									<td>
										<span id="actTempOutdoorWS1" style="font-size:50px; vertical-align:middle; text-align:center" yaha="io_mode:read_cyclic ; format:0.0">0.0</span><span style="font-size:30px; vertical-align:top; text-align:center"> &#8451;</span>
									</td>
									<td style="width: 50px">
								...
								<tr>
									<td style="text-align:center">
										$yaha_tuid:feelslike$ <span id="actTempOutdoorFeelsLikeWS1" yaha="io_mode:read_cyclic ; format:0.0 ; unit:$deg$C>$deg$C show">0.0</span>
									</td>
									<td>
									</td>
								</tr>
								...
								<tr>
									...
									<td style="padding-top: 0.7em; text-align:right">
										<span id="actHumidityOutdoorWS1" yaha="io_mode:read_cyclic">0</span> %
									</td>
								...
								<tr>
									...
									<td style="padding-top: 0.7em; text-align:right">
										<span id="relativePressureWS1" yaha="io_mode:read_cyclic">0</span> hPa
									</td>
									<td  style="padding-top: 0.7em; width: 50px">
								...
								<tr>
									...
									<td style="padding-top: 0.7em; text-align:right">
										<span id="uvRadiationIndexWS1" yaha="io_mode:read_cyclic">0</span> $yaha_tuid:of$ 10
									</td>
									<td  style="padding-top: 0.7em; width: 50px">
								...
								<tr>
									...
									<td colspan=2 style="padding-top: 0.7em; text-align:right">
										<span id="rainHourlyWS1" yaha="io_mode:read_cyclic">0</span> $yaha_tuid:mmperhour$
									</td>
								</tr>
							...
							<tbody>
								<tr>
									...
									<td  style="padding-left: 1.5em">
										<span id="windSpeedWS1" style="font-size:50px; vertical-align:middle; text-align:center" yaha="io_mode:read_cyclic ; format:0.0">0.0</span><span style="font-size:30px; vertical-align:top; text-align:center"> km/h</span>
									</td>
								</tr>
								<tr>
									<td style="text-align:center">
										$yaha_tuid:gust$ <span id="windGustWS1" yaha="io_mode:read_cyclic ; format:0.0 ; unit:km/h>km/h show">0.0</span>
									</td>
								</tr>
		...
		<div id="yaha_submodule_3" class="yaha-submodule" yaha="module_name: $yaha_tuid:wind$ ; module_icon: yaha_chart">
			<div style="margin-top: 20px;"; id="windhistorychart">
			<!-- filled by function -->
			</div>
