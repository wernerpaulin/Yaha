	...
	<![CDATA[
		<script type="text/javascript">
			...
			function moduleInit()
			{
				...
				/* Show main navigation when overview page is loaded for fast transaction*/
			    ...
			    $('#' + "animationtest").on( "load", function(e) 
				{
		...
		<div id="yaha_submodule_1" class="yaha-submodule" yaha="module_name: $yaha_tuid:dashboard$ ; module_icon: yaha_dashboard; visible: onload">
			<object data="../yaha/core/svg/symbol_window_blind.svg" type="image/svg+xml" id="animationtest"></object>
		</div>
			...
			<div class="yaha_flex_container">
				<div class="yaha_flex_item">
					<div data-role="collapsible" id="languageSelector">
						<h4>$yaha_tuid:languageselection$</h4>
					</div>	
				</div>
				
				<div class="yaha_flex_item">
					<div data-role="collapsible" id="setDateTimeCollapsible">
						<h4>$yaha_tuid:dateandtime$</h4>
