    ...
    def update(self):
        ...
        if (len(self.txData) == 0):
            try:    #see whether there is data (assume entire frame is there)
                ...
                self.tagsToWrite = core.pdi.yaha_data.YahaPDIwriteValue({}, self.tagsToWrite)
                self.tagsToRead = core.pdi.yaha_data.YahaPDIreadValue({}, self.tagsToRead)
