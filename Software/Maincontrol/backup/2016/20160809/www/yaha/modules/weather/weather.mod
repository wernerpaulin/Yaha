...
<module>
	...
	<![CDATA[
		<script type="text/javascript">
			...
			var LineChartLegendTranslation = {}
			...
			function moduleInit()
			{
				...
				jQuery.post(CGI_SCRIPT_NAME_YAHA_VIEW, cgiData,
				    ...
				    {	
						...
						LineChartLegendTranslation =jQuery.parseJSON(jsonDataFromServer)

						drawLineChart("weather_linechart", fileName, "actTempOutdoor", "%Y.%m.%d %H:%M:%S", "%d %b %H:%M", "", 15, LineChartLegendTranslation)
				    });	
