			...
			<div class="yaha_flex_container">
				...
				<div class="yaha_flex_item">
					<div class="ui-body ui-body-a ui-corner-all ui-dashboard-panel">
				    	...
				    	<a href="#" data-role="button" data-inline="true" data-mini="true" id="cmdMasterBathBlindOpen" yaha="io_mode:write_click ; tag_group_wr_click:MASTER_BATH_BLIND_OPEN">open</a>
				    	<a href="#" data-role="button" data-inline="true" data-mini="true" id="cmdMasterBathBlindClose" yaha="io_mode:write_click ; tag_group_wr_click:MASTER_BATH_BLIND_CLOSE">close</a>
				    	<a href="#" data-role="button" data-inline="true" data-mini="true" id="cmdMasterBathBlindStop" yaha="io_mode:write_click ; tag_group_wr_click:MASTER_BATH_BLIND_STOP">stop</a>

						<p>
						Set position<input type="text" id="masterBathBlindSetPosition" yaha="io_mode:read_cyclic, write_enter">
				    	<a href="#" data-role="button" data-inline="true" data-mini="true" id="cmdMasterBathStartMovement" yaha="io_mode:write_click ; tag_group_wr_click:MASTER_BATH_BLIND_START_MOVEMENT">go</a>
						</p>

						<p>Date and Time enable: <input type="checkbox" id="masterBathBlindTimeEnable" yaha="io_mode:read_cyclic, write_change" data-role="flipswitch" data-wrapper-class="yaha-flipswitch-onoff" data-off-text="Aus" data-on-text="Ein"></input></p>
						<p>Auto shading enable: <input type="checkbox" id="masterBathBlindAutoShadingEnable" yaha="io_mode:read_cyclic, write_change" data-role="flipswitch" data-wrapper-class="yaha-flipswitch-onoff" data-off-text="Aus" data-on-text="Ein"></input></p>
						...
						<p>Actual blind position: <span id="masterBathBlindActPosition" yaha="io_mode:read_cyclic ; format:00 ; unit:%>% show">tbd...</span></p>
						
						<a href="#" data-inline="true" data-role="button" data-mini="true" id="cmdMasterBathBlindTeach" yaha="io_mode:write_click ; tag_group_wr_click:MASTER_BATH_BLIND_TEACH">learn</a>
