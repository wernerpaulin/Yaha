		...
		<div id="yaha_submodule_1" class="yaha-submodule" yaha="module_name: $yaha_tuid:nav0001$ ; module_icon: yaha_dashboard; visible: onload">
			<table data-role="table" class="ui-responsive ui-shadow">
				...
				<tbody>
					  ...
					  <tr>
					    <td>Blink on time:</td>
					    <td><input type="text" id="uiLight1BlinkOntime" yaha="io_mode:read_cyclic, write_enter"></input></td>
					    <td><input type="text" id="uiLight2BlinkOntime" yaha="io_mode:read_cyclic, write_enter"></input></td>
					  </tr>
					  <tr>
					    <td>Blink off time:</td>
					    <td><input type="text" id="uiLight1BlinkOfftime" yaha="io_mode:read_cyclic, write_enter"></input></td>
					    <td><input type="text" id="uiLight2BlinkOfftime" yaha="io_mode:read_cyclic, write_enter"></input></td>
					  </tr>
					  ...
					  <tr>
					    <td>Impulse duration:</td>
					    <td><input type="text" id="uiLight1ImpulseDuration" yaha="io_mode:read_cyclic, write_enter"></input></td>
					    <td><input type="text" id="uiLight2ImpulseDuration" yaha="io_mode:read_cyclic, write_enter"></input></td>
					  </tr>
					  <tr>
					  ...
					  <tr>
					    ...
					    <td><input type="text" id="uiLight1OffDelayDuration" yaha="io_mode:read_cyclic, write_enter"></input></td>
					    <td><input type="text" id="uiLight2OffDelayDuration" yaha="io_mode:read_cyclic, write_enter"></input></td>
					  </tr>
