...
class main:
    ...
    def __init__(self, path, pdi):
        ...
        '''
        IO-Typ von PDI umbenennen in isSettings: yaha_data, alle module-PDI files, Excel = xml neu generieren
        Beim Init ActiveSettings.xml auslesen und internen load() auslösen
