							...
							<tbody>
								<tr>
									...
									<td style="padding-left: 1em">
										<span id="actTempOutdoorWS1" yaha="io_mode:read_cyclic ; format:0.0 ; unit:$deg$C>$deg$C show">0.0</span>
									</td>
								</tr>
								<tr>
									<td>
										<br>
										<span>$yaha_tuid:wind$</span>
									</td>
									<td style="padding-left: 1em">
										<span id="windSpeedWS1" yaha="io_mode:read_cyclic ; format:0.0">0.0</span><span> km/h</span>
									</td>
								</tr>
							</tbody>
						</table>
						...
						<table>
							<tbody>
								<tr>
									...
									<td style="padding-left: 1em">
										<span id="actTempIndoorWS1" yaha="io_mode:read_cyclic ; format:0.0 ; unit:$deg$C>$deg$C show">0.0</span>
									</td>
								</tr>
							</tbody>
						</table>
						...
						<table>
							<tbody>
								<tr>
									...
									<td style="padding-left: 1em">
										<span id="ioActTempLivingroom" yaha="io_mode:read_cyclic ; format:0.0 ; unit:$deg$C>$deg$C show">0.0</span>
									</td>
								</tr>
							</tbody>
						</table>
					  	...
					  	<table>
					  		<tbody>
					  			...
					  			<tr>
					  				...
					  				<td><span id="systemTickRunTime" yaha="io_mode:read_cyclic ; format:00.## ; unit:s>ms show">00.0</span></td>
					  			</tr>
					  			<tr>
					  				<td>$yaha_tuid:cpuload$</td>
					  				<td><span id="cpuLoad" yaha="io_mode:read_cyclic ; format:00.# ; unit:N>% show">00.0</span></td>
					  			</tr>
					  			<tr>
									<td colspan="2">
