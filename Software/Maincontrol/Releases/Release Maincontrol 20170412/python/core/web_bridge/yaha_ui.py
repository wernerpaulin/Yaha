...
class Server:
    ...
    def update(self):
        ...
        if (len(self.txData) == 0):
            ...
            except Exception, self.e: #try again next cycle in case no date was there.
                #print("UI Update exception: {0}".format(self.e))
                self.txData.clear()
        ...
        if (len(self.txData) > 0):
            ...
            #except Exception as e: #Python3
                ...
                print("UI Server send exception: {0}".format(e))
                self.txData.clear()
